...
export default async function FollowUpsPage() {
  ...
  return (
    <div className="space-y-8">
      <section className="hero-panel rounded-[2.6rem] p-8">
      ...
      {pendingTaskCount === 0 && autopilot.completedRecently.length === 0 ? (
        <section className="quiet-panel rounded-[2rem] border border-dashed border-stone-300 p-8 text-center shadow-none">
          <h2 className="font-serif text-3xl text-stone-900">No follow-up queue yet</h2>
